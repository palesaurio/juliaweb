                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <ul className="space-y-2 text-gray-700">
                        <li>• UNIVERSIDAD POPULAR AUTONOMA DE VERACRUZ (UPAV)</li>
                        <li>• MAESTRIA EN JUICIOS ORALES</li>
                        <li>• UNIVERSIDAD VERACRUZNA CON CERTIFICACION DEL CEJAV (CEJAV/30-MCE 209/2022)</li>
                        <li>• UNIVERSIDAD POPULAR AUTONOMA DE VERACRUZ (UPAV)</li>
